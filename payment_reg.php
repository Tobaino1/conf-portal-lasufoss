...
<div class="super_container">
    ...
    <div class="home">
        ...
        <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/pricing.jpg"
             data-speed="0.8"></div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="home_content d-flex flex-row align-items-end justify-content-start">
                            <div class="current_page">Payment</div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="news_items">
                        ...
                        <div class="news_item">
                            ...
                            <!--                                    <a href="#">-->
                            <!--										<span class="date_content d-flex flex-column align-items-center justify-content-center">-->
                            <!--											<div class="date_month">14 - 17</div>-->
                            <!--											<div class="date_month">November</div>-->
                            <!--											<div class="date_month">2019</div>-->
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                        <div class="tickets">
                            ...
                            <!--<div class="tickets_title">Congress Theme</div>-->
                            <!--<div class="tickets_text">'' Africa in the 21st Century: Towards an Agenda for Urgent Repositioning ''</div>-->
                            <!--&lt;!&ndash;								<div class="tickets_next"><a href="#">See Next Event</a></div>&ndash;&gt;-->
                            <!--&lt;!&ndash;								<div class="button tickets_button"><a href="#">Buy Tickets Now!</a></div>&ndash;&gt;-->
                            <!--</div>-->
                        </div>
